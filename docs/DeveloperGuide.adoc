...
|`* * *` |investigator |edit an investigator |update his/her particulars if necessary

|`* * *` |investigator |edit a case |update details of the case if necessary
...
|`*` |investigator with investigators in my team |sort investigators by name |locate an investigator easily
|=======================================================================
