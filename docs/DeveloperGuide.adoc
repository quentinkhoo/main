...
* Marcus Chen
* Poh Kai Jun
** Created a `findtags` commad
*** This feature helps the investigators to filter out investigators that are in a certain team/category according
...
|`* * *` |investigator |view my cases |to know what what are the cases that is assigned  
