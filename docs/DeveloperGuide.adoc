...
<<investigator, investigators>> to easily manage <<crimecase, crime cases>>
that have been
delegated to them.
...
the Investigapptor project. To get started, jump to <<Setting Up>>.

== Setting Up
This section provides you with simple and easy to follow instructions
...
// tag::password[]
=== Password feature
The password feature allows for <<investigator, investigators>> to set a password
...
** Cons: There is no <<access-control, access control>> between investigators of different
ranks.
...
<<access-control,access control>> between investigators of different ranks.
