...
* *Quentin Khoo*
** *Major enhancement*: Support notifying investigators when they get assigned a case
*** This would allow for investigators to be aware when they get assigned a case to solve.
** *Minor enhancement*: Add command aliases for most commands
*** These aliases can be used in place of the full commands for the investigator's convenience.
