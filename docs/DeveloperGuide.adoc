...
* *Poh Kai Jun*
** *Major Enhancement*: Support for evidence package (Add, Delete, Update, View, Search)
*** This feature allows cases to store evidences details related to the case.
...
1.  Investigapptor shows a list of persons
2.  User add a case to select investigator by index with case information
3.  Case is added to investigator
+
Use case ends.
