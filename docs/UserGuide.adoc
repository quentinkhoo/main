...
=== Locating investigators by category/team: `findInvestTags` `[Coming in v1.3]`
...
* `list investigators` +
`selectInvest 2` +
Selects the 2nd person in the results of the `list investigators` command.
* `find Betsy` +
...
* `list cases` +
`selectCase 2` +
Selects the 2nd case in the results of the `list cases` command.
* `findCase murder` +
`selectCase 1` +
Selects the 1st case in the results of the `findCase` command.
* `sC 3` +
Selects the 3rd case in the listed panel list cases.
