...
image::userguide-images/undo-command-1.png[width="320"]

[[undo-2]]
.After `deletecase 1` command
image::userguide-images/undo-command-2.png[width="320"]
...
[[undo-4]]
.`undo` command
image::userguide-images/undo-command-4.png[width="320"]
