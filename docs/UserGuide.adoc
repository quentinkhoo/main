...
to view more information the evidence related in the case.

==== Setting up chain of custody `buildcoc` [Coming in v2.0]
We plan to store the history of the investigator in charge of each case, allowing the Investigapptor to display
