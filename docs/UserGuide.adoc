...
You can delete investigator from Investigapptor if you no longer want them saved in the investigapptor. +
...
You view more information about the investigator by either using the mouse to click on the investigator card or use the
`selectinvestigator` command. +
...
You can identify and select the investigator by looking at their `INDEX` at the top left of their card as show in the
diagram in <<selectinvest-index>> or by double clicking the investigator card.


[[selectinvest-index]]
.Investigator Card and Index
image::userguide-images/di-command-index.png[width="320"]
...
You will be able to see the success message and the browser panel will now display the information of the investigator
you have selected as show in <<selectinvest-outcome>> +

[[selectinvest-outcome]]
.Placeholder
image::userguide-images/di-command.png[width="500"]
