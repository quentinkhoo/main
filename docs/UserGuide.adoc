...
=== Adding a case: `create`

Adds a case to the application +
Format: `create [n/CASE_NAME] [d/DESCRIPTION] [i/INDEX] [s/START_DATE] [t/TAG]...` +
Alias: `c`
...
* `create n/Geylang Rape d/Rape at geylang i/1 s/12/05/1994 t/Rape t/prostitution`
* `create n/Bedok Riot i/3 s/12/05/2017 d/Riot at bedok 85 t/Rape t/prostitution`
* `c n/Geylang Rape d/Rape at geylang i/1 s/12/05/1994`
