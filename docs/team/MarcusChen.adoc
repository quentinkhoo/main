...
+
Investigator class extends the Person class with an addtional variable that stores the investigators cases
** Implemented UniqueCrimeCase class
+
UniqueCrimeCase stores and manages multiple cases as well as ensure that they are all unique
