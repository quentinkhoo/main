...
|===
|_Given below are some sections I contributed to the User Guide. They showcase my ability to write documentation targeting end-users. +
Here are all the sections that I have contributed: https://github.com/CS2103JAN2018-F14-B3/main/blob/master/docs/UserGuide.adoc#FindInvTags[1],
...
https://github.com/CS2103JAN2018-F14-B3/main/blob/master/docs/UserGuide.adoc#CasesCalendar[6]_
|===
...
|===
|_Given below are some sections I contributed to the Developer Guide. They showcase my ability to write technical documentation and the technical depth of my contributions to the project. +
Here are all the sections that I have contributed: https://github.com/CS2103JAN2018-F14-B3/main/blob/master/docs/DeveloperGuide.adoc#Find-Feature[1],
https://github.com/CS2103JAN2018-F14-B3/main/blob/master/docs/DeveloperGuide.adoc#Calendar-Feature[2]_
|===
