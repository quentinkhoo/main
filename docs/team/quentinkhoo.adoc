...
* *Minor enhancement*: implemented Ui support for automated swapping of tabs
** What it does: Allows the panel to automatically switch to the appropriate
    display list depending on the command input.
