...
public class EditInvestigatorCommandParserTest {

    private static final String TAG_EMPTY = " " + PREFIX_TAG;

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditInvestigatorCommand.MESSAGE_USAGE);

    private EditInvestigatorCommandParser parser = new EditInvestigatorCommandParser();
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1", EditInvestigatorCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditInvestigatorCommand expectedCommand = new EditInvestigatorCommand(targetIndex, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditInvestigatorCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
