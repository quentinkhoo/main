...
public class InvestigatorUtil {
    ...
    public static String getRegCommand(Investigator investigator) {
        return AddInvestigatorCommand.COMMAND_WORD + " " + getInvestigatorDetails(investigator);
    }
    ...
    public static String getAliasRegCommand(Investigator investigator) {
        return AddInvestigatorCommand.COMMAND_ALIAS + " " + getInvestigatorDetails(investigator);
    }
