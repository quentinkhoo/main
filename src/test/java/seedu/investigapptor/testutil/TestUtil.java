...
public class TestUtil {
    ...
    public static Index getMidIndex(Model model) {
        return Index.fromOneBased(model.getInvestigapptor().getPersonList().size() / 2);
    }
    ...
    public static Index getLastIndex(Model model) {
        return Index.fromOneBased(model.getInvestigapptor().getPersonList().size());
    }
    ...
    public static Person getPerson(Model model, Index index) {
        return model.getInvestigapptor().getPersonList().get(index.getZeroBased());
    }
}
