...
import seedu.investigapptor.ui.StatusBarFooter;

/**
 * A system test class for the help window, which contains interaction with other UI components.
 */
public class HelpCommandSystemTest extends InvestigapptorSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectInvestigatorCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased());
        ...
        executeCommand(DeleteInvestigatorCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased());
