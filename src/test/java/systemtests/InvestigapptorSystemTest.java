 ...
 */
public abstract class InvestigapptorSystemTest {
    @ClassRule
    ...
    protected Investigapptor getInitialData() {
        return TypicalPersons.getTypicalInvestigapptor();
    }
    ...
    protected void deleteAllPersons() {
        ...
        assertEquals(0, getModel().getInvestigapptor().getPersonList().size());
    }
    ...
    protected void assertApplicationDisplaysExpected(String expectedCommandInput, String expectedResultMessage,
        ...
        assertEquals(expectedModel.getInvestigapptor(), testApp.readStorageInvestigapptor());
